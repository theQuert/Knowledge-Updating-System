...
class PRIMERSummarizerLN(pl.LightningModule):
    def __init__(self, args):
        ...
        # self.tokenizer = AutoTokenizer.from_pretrained(args.tokenize_path)
        ...
        # self.tokenizer.add_tokens(['<KEEP>', '<ADD>', '<SUB>'])
        # special_tokens_dict = {'additional_special_tokens': ['[KEEP]', '[ADD]', '[SUB]']}
    ...
    def compute_rouge_batch(self, input_ids, output_ids, gold_str):
        ...
        for ref, pred in zip(gold_str, generated_str):
            ...
            preds.append(pred)
        path_file = os.path.join('/home/quert/MDS_PRIMER/primer/outputs', 
    ...
    def compute_rouge_all(self, outputs, output_file=None):
        ...
        rouge_results.to_csv('/home/quert/MDS_PRIMER/primer/outputs/rouge_result.csv')
...
if __name__ == "__main__":
    ...
    #    "--tokenize_path",
    #    type=str,
    #    default="/home/a97041304/MDS_PRIMER/primer/PRIMER_tagged",
    #)

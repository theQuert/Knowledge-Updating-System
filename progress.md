...
- Upload the local `src` and `tgt` to VM. Then, construct the upated pt file and do sentence-labeling. (Running)
- After labeling, calculate the sum of #RM, #ADD, #SUB. (Calculate the averaged edit-actions)

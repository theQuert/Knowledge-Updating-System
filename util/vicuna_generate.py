...
parser.add_argument("--model_path", type=str, default="/model/13B_hf") # replaced with Vicuna checkpoints
parser.add_argument("--lora_path", type=str, default="checkpoint-3000") # replaced with Vicuna+LoRA checkpoints

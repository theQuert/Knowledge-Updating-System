...
parser.add_argument("--lora_path", type=str, default="/home/quert/NetKUp/util/netku-Vicuna") # replaced with Vicuna+LoRA checkpoints
...
def vicuna_output():
    inputs_df = pd.read_csv("/home/quert/NetKUp/util/experiments/paragraphs_with_prompts.csv")
    prompts_input = inputs_df.paragraph.to_list()

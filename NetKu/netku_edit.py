...
train_pt = torch.load('/content/drive/MyDrive/NetKu/train.pt')
# train_pt = torch.load('../../NetKu/full_content/check_cands.pt')
# train_pt = torch.load('../../edit_NetKu/util/train_labeled.pt')


test_pt = torch.load('/content/drive/MyDrive/NetKu/test.pt')
val_pt = torch.load('/content/drive/MyDrive/NetKu/val.pt')
